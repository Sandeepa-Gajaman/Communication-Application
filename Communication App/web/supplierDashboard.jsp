<%-- 
    Document   : supplierDashboard
    Created on : May 12, 2018, 10:58:04 AM
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
         <div id="h1Styl">
          <h1 align="center">Supplier Dashboard</h1><br>
         </div>
        ...
        <div>
            ...
            <% 
                while(resultSet1.next()){
                    threadId= resultSet1.getInt(1); userId= resultSet1.getInt(3); reciverId=resultSet1.getInt(4);  
                    out.print("<tr class= 'clickable-row' data-href= 'viewThread.jsp?threadId="+ threadId +"&userId="+ userId +"&receiverId="+ reciverId +"'><td>"+ resultSet1.getString(5)+"</td><td>" + resultSet1.getString(7)+"</td><td>" + resultSet1.getString(8)+"</td></tr>");
                }
            %>       
             ...
             <thead><tr><th>Project ID</th><th>City</th><th>Budget</th><th>Start Date</th><th>Deadline</th><th>Description</th></tr></thead>
                <% 
                    while(resultSet2.next()){
                      projectId= resultSet2.getInt(1); userId= resultSet2.getInt(2);; 
                      out.print("<tr class= 'clickable-row' data-href= 'viewThread.jsp?projectId="+ projectId +"&userId="+ userId +"'><td>"+ resultSet2.getString(1)+"</td><td>" + resultSet2.getString(3)+"</td><td>"+ resultSet2.getString(4)+"</td><td>"+ resultSet2.getString(5)+"</td><td>"+ resultSet2.getString(6)+"</td><td>"+ resultSet2.getString(7)+"</td></tr>");
                    }
                %>
            </table>
        </div>

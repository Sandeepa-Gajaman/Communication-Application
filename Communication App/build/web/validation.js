...
function validateFirstName()
 ...
 {
     //var usertype=document.getElementById("suppliertypename").value;
     var e = document.getElementById("usertype");
     var Uservalue = e.options[e.selectedIndex].value;
     if(Uservalue=="supplier")
     {
         
     document.getElementById("suppliertypename").style.display="block";
     ...
     {
     document.getElementById("suppliertypename").style.display="none";
     document.getElementById("suppliertype").style.display="none";
     document.getElementById("descriptionname").style.display="none";

 ...
 * Processes existing thread forms.
 */
...
public class NewMessageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("submit").equals("") || request.getParameter("senderId").equals("") || request.getParameter("threadId").equals("")){response.sendRedirect("generalErrors.jsp?error=4"); return;}
        ...
        try{
            messageProcess.createNewMessage(threadId, senderId, message, encodedImage);
            messageProcess.setThreadAsUnread(threadId);
        }
        ...
        response.sendRedirect("viewThread.jsp?threadId=" + threadId); return; 
        //processRequest(request, response);
    }
